...
export const useExampleSuggestions = () => {
  useConfigureSuggestions({
    ...
    suggestions: [
      {
        title: "Create an estimation",
        message: "Can you help provide an estimate to the new server that I plan to build?"
      },
      {
        title: "Generate a proposal",
        message: "Can you help generate a proposal to the new server that I plan to build?"
      },
      {
        title: "Download a proposal",
        message: "Can you help download a proposal I already created?"
      }
    ],
    available: "always",
  });
